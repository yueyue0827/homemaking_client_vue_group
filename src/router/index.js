...
export const asyncRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'address',
        hidden: true,
        component: () => import('@/pages/customer/Address'),
        name: 'address',
        meta: { title: '顾客地址', icon: 'tab' }
      },
      {
        path: 'customer_order',
        hidden: true,
        component: () => import('@/pages/customer/Customer_order'),
        name: 'customer_order',
        meta: { title: '顾客订单', icon: 'tab' }
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'category_order',
        hidden: true,
        component: () => import('@/pages/category/Category_order'),
        name: 'category_order',
        meta: { title: '栏目订单', icon: 'tab' }
      },
      {
        path: 'product',
        hidden: true,
        component: () => import('@/pages/category/Product'),
        name: 'product',
        meta: { title: '产品信息', icon: 'tab' }
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'comment',
        hidden: true,
        component: () => import('@/pages/order/Comment'),
        name: 'comment',
        meta: { title: '订单评论', icon: 'tab' }
      }
    ]
  },
  {
